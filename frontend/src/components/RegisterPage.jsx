...
import { GraduationCap, Mail, Lock, Loader2, ArrowRight, User, IdCard } from 'lucide-react';
...
const RegisterPage = () => {
    ...
    return (
        <div className="min-h-screen flex items-center justify-center bg-slate-50 dark:bg-navy-900 relative overflow-hidden font-sans transition-colors duration-500">
            ...
            <div className="absolute top-[-10%] left-[-10%] w-[800px] h-[800px] bg-indigo-200/40 dark:bg-indigo-600/10 rounded-full blur-[120px]" />
            <div className="absolute bottom-[-10%] right-[-10%] w-[800px] h-[800px] bg-cyan-200/40 dark:bg-cyan-600/10 rounded-full blur-[120px]" />
            ...
            >
                <div className="flex flex-col items-center mb-10">
                    ...
                    <p className="text-slate-500 dark:text-slate-400 font-medium text-center">Join AdvisR and start your journey</p>
                </div>
                    ...
                    <div className="space-y-5">
                        <div className="space-y-1.5">
                            ...
                            <div className="relative group">
                                <User className="absolute left-4 top-1/2 -translate-y-1/2 text-slate-400 dark:text-slate-500 group-focus-within:text-indigo-500 dark:group-focus-within:text-cyan-400 transition-colors" size={20} />
                                <input
                                    type="text"
                                    name="name"
                                    value={formData.name}
                        ...
                        <div className="space-y-1.5">
                            <label className="text-sm font-semibold text-slate-700 dark:text-slate-300 ml-1">Registration Number</label>
                            <div className="relative group">
                                <IdCard className="absolute left-4 top-1/2 -translate-y-1/2 text-slate-400 dark:text-slate-500 group-focus-within:text-indigo-500 dark:group-focus-within:text-cyan-400 transition-colors" size={20} />
                                <input
                                    type="text"
                                    name="reg_no"
                ...
                <div className="mt-8 text-center text-sm text-slate-500 dark:text-slate-400 font-medium">
                    ...
                    <Link to="/login" className="text-indigo-600 dark:text-cyan-400 hover:text-indigo-500 dark:hover:text-cyan-300 font-bold transition-colors underline decoration-2 decoration-transparent hover:decoration-indigo-500 dark:hover:decoration-cyan-400">Sign In</Link>
                </div>
            </motion.div>
        </div>
    );
